<?php $pageTitle = "International Students | Richard"; include "inc/heading.php"; ?>
...
<body class="container">
	...
	<nav class="main">
		<ul>
			...
			<li><a href="richard_o_akomea.php" class="is-current">Richard</a></li>
		</ul>
	</nav>
